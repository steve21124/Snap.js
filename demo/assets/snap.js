            ...
            translate: {
                ...
                easeTo: function(n) {
                    ...
                    utils.events.addEvent(settings.element, transitionCallback, function() {
                        ...
                        if (settings.addBodyClasses && cache.translation===0) {
                ...
                endDrag: function(e) {
                    if (cache.isDragging) {
                        ...
                        if (cache.dragWatchers.current === 0 && translated !== 0 && settings.tapToClose) {
                            ...
                            cache.startDragX = 0;
                            return;
                        //If we end a drag right at 0, remove the body classes since we don't have a transition
                        } else if (settings.addBodyClasses && translated === 0) {
                            utils.klass.remove(doc.body, 'snapjs-right');
                            utils.klass.remove(doc.body, 'snapjs-left');
                        }
                        // Revealing Left
